...
exports.userRegister = async (req, res) => {
    ...
    try {
        ...
        UanNumber varchar(20), bankAccNumber varchar(20) not null, bankName varchar(20), bankIfscCode varchar(10),createdOn date not null,probitiondate date not null,probitionstatus varchar not null)`
